...
const About = () => {
  ...
  return (
    <section id="about" className="py-40 bg-[#000101] relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-40">
            ...
            >
              ...
              <h2 className="text-6xl md:text-7xl font-black text-white mb-10 tracking-tighter leading-none">
                Engineering <br />
                <span className="text-[#4353FF] text-glow">The Digital Backbone</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-12">
                {stats.map((stat, idx) => (
                  <div key={idx} className="relative group">
                    <div className="absolute -left-6 top-1/2 -track-y-1/2 w-1 h-0 bg-[#4353FF] group-hover:h-full transition-all duration-500 -translate-y-1/2" />
            ...
            >
              <SpotlightCard containerClassName="aspect-[4/5] rounded-[3rem]" className="p-12 flex flex-col justify-end border-gradient overflow-hidden">
                <div className="absolute inset-0 bg-grid-modern opacity-20 pointer-events-none" />

                <div className="relative z-10">
                  <div className="w-20 h-20 bg-[#4353FF]/20 rounded-2xl flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(67,83,255,0.2)]">
                    <Server className="w-10 h-10 text-[#4353FF]" />
                  </div>
                  <h3 className="text-4xl font-black text-white mb-6 uppercase tracking-tight">Core <br />Philosophy</h3>
                  <div className="w-16 h-1.5 bg-[#4353FF] mb-8" />
                ...
                {/* Decorative glows */}
                <div className="absolute -top-1/4 -right-1/4 w-3/4 h-3/4 bg-[#4353FF]/10 blur-[100px] rounded-full group-hover:bg-[#4353FF]/20 transition-all duration-700 pointer-events-none" />
              </SpotlightCard>
            </motion.div>
          </div>
            ...
            {highlights.map((item, idx) => (
              ...
              >
                <SpotlightCard className="p-12 border-gradient h-full">
                  <div className="w-16 h-16 bg-[#4353FF]/10 rounded-2xl flex items-center justify-center mb-8 border border-[#4353FF]/20 group-hover:scale-110 transition-transform duration-500 relative z-10">
                    <item.icon className="w-8 h-8 text-[#4353FF]" />
                  </div>
                  <h4 className="text-2xl font-black text-white mb-4 group-hover:text-[#4353FF] transition-all duration-300 uppercase tracking-tight relative z-10">
                    {item.title}
                  </h4>
