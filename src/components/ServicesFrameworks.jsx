...
>>>>>>> ab60e23 (GoCodexa Commit)
  ...
  return (
    <section
      id="services"
      className="py-24 bg-[#000101] relative overflow-hidden"
    >
      {/* Background */}
...
>>>>>>> ab60e23 (GoCodexa Commit)
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Services</h3>
            <p className="text-white/40 text-sm mb-8 leading-relaxed">
              We provide support for all of your custom software development
              projects.
            </p>
          ...
          >
            <div className="w-12 h-12 bg-[#4C91C9]/10 rounded-xl flex items-center justify-center mb-6 border border-[#4C91C9]/20 group-hover:scale-110 transition-transform">
              <Atom className="w-6 h-6 text-[#4C91C9]" />
            </div>

            <h3 className="text-2xl font-bold text-white mb-3">Frameworks</h3>
            <p className="text-white/40 text-sm mb-8 leading-relaxed">
              The best software development firms start their web development
          ...
          <motion.div
            ...
            className="hidden lg:block relative"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#4C91C9]/10 to-transparent rounded-3xl" />
            ...
            <div className="relative h-full p-6 flex flex-col gap-4">
              ...
              {/* Floating badge */}
              <div className="absolute bottom-4 right-4 bg-[#4C91C9] rounded-full px-4 py-2 shadow-lg shadow-[#4C91C9]/30">
